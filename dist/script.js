...
var changeModalState = function changeModalState(state) {
  ...
  bindActionToElems('click', windowForm, 'form'), bindActionToElems('input', windowHeight, 'height'), bindActionToElems('input', windowWidth, 'width'), bindActionToElems('change', windowType, 'type'), bindActionToElems('change', windowProfile, 'profile');
};
...
var images = function images() {
  ...
  workSections.addEventListener('click', function (e) {
    e.preventDefault();
    var target = e.target;
